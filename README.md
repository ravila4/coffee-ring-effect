...
Procedural coffee stains generated by simulating the coffee-ring physics
(Deegan et al.), rendered once to a canvas and reusable as a static image.
Zero dependencies, 40 to 120 ms per stain, seed-reproducible.
...
broad rims). Render once and reuse the canvas as an image; generation cost
is paid exactly once per seed.
